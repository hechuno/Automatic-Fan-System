...
- pin_list:
  ...
  - {pin_num: '55', peripheral: GPIOC, signal: 'GPIO, 10', pin_signal: PTC10/I2C1_SCL}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_I2C0_SCL_PORT, BOARD_I2C0_SCL_PIN, kPORT_MuxAlt2);

    /* PORTB1 (pin 36) is configured as I2C0_SDA */
    PORT_SetPinMux(BOARD_I2C0_SDA_PORT, BOARD_I2C0_SDA_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_I2C1_SCL_PORT, BOARD_I2C1_SCL_PIN, kPORT_MuxAsGpio);
...
void BOARD_InitLEDsPins(void)
{
    ...
    const port_pin_config_t MOTOR = {/* Internal pull-up/down resistor is disabled */
                                            kPORT_PullDisable,
                                            /* Slow slew rate is configured */
                                            kPORT_SlowSlewRate,
                                            /* Passive filter is disabled */
                                            ...
                                            /* Pin is configured as PTA13 */
                                            kPORT_MuxAsGpio};
    PORT_SetPinConfig(BOARD_MOTOR_PORT, BOARD_MOTOR_PIN, &MOTOR);
